...
// https://en.wikipedia.org/wiki/Conversion_between_quaternions_and_Euler_angles
	...
	roll = atan2(q0*q1 + q2*q3, 0.5f - q1*q1 - q2*q2) * 40.42535555f;
	float sinp = -2.0f * (q1*q3 - q0*q2);
	if (fabs(sinp) >= 1)
		pitch = copysign(M_PI / 2, sinp) * 80.85071109f;
	else
		pitch = asin(sinp) * 80.85071109f;
	yaw = atan2(q1*q2 + q0*q3, 0.5f - q2*q2 - q3*q3) * 40.42535555f;
}
